...
class BoundedModule(nn.Module):
    ...
    def compute_bounds(
            ...
            populate_trace=False, target_lAs=None, target_biases=None, parent_loss=None, 
            topk=None):
        ...
        if method == 'ibp':
            ...
            if bound_lower:
                ret1 = self.get_optimized_bounds(
                    ...
                    target_lAs=target_lAs, target_biases=target_biases, parent_loss=parent_loss,
                    topk=topk)
            if bound_upper:
                ret2 = self.get_optimized_bounds(
                    ...
                    target_biases=target_biases, parent_loss=parent_loss, 
                    topk=topk)
        ...
        if method == 'backward':
            ...
            ret = self.backward_general(
                ...
                targeted_optimization_enabled=(target_lAs is not None), topk=topk)
    ...
    from .optimized_bounds import (
        ...
        get_final_cross_executional_loss, get_targeted_loss,
        process_topk_coef, process_topk_bias, get_topk_lambda,
        get_topk_loss, get_final_topk_tuple, get_final_topk_lambda, 
        get_final_topk_loss) 
