...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument("--timeout", type=float, default=120,
        ...
        h = ["cross_ex"]
        self.add_argument('--enable_cross_ex', type = bool, default = True, dest='enable_cross_ex', help='Enable cross-executional refinement.', hierarchy = h + ["enable_cross_ex"])
        self.add_argument('--tensor_storage_size', type = int, default = 1024, dest='tensor_storage_size', help='Size of Allocated Tensors.', hierarchy = h + ["tensor_storage_size"])
        ...
        h = ["bab", "branching"]
        self.add_argument("--branching_method", default="babsr",
