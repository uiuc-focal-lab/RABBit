...
class TestSparsificatioCIFAR_02(TestCase):
    def test_deepz_standard(self):
        ...
        enable_sparsification = True
        store_in_file = True
        output_dir='final_results/cifar10-alpha-crown/'  
        args = pt.TransferArgs(net=config.CIFAR_STANDARD_CONV, domain=Domain.LIRPA_CROWN_FORWARD, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=0.2/255,
    ...
    def test_deepz_pgd_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-alpha-crown/'  
        args = pt.TransferArgs(net=config.CIFAR_CONV_SMALL, domain=Domain.LIRPA_CROWN_FORWARD, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=0.2/255,
                               split=Split.RELU_ESIP_SCORE, count=100, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
    ...
    def test_deepz_diffai_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-alpha-crown/'  
        args = pt.TransferArgs(net=config.CIFAR_CONV_DIFFAI, domain=Domain.LIRPA_CROWN_FORWARD, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=0.2/255,
                               split=Split.RELU_ESIP_SCORE, count=100, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
    ...
    def test_deepz_colt_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-alpha-crown/'  
        args = pt.TransferArgs(net=config.CIFAR_CONV_COLT, domain=Domain.LIRPA_CROWN_FORWARD, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=0.2/255,
                               split=Split.RELU_ESIP_SCORE, count=100, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
    ...
    def test_deepz_crown_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-alpha-crown/'  
        args = pt.TransferArgs(net=config.CIFAR_CROWN_IBP, domain=Domain.LIRPA_CROWN_FORWARD, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=0.2/255,
                               split=Split.RELU_ESIP_SCORE, count=100, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
...
class TestSparsificatioCIFAR_2(TestCase):
    def test_deepz_pgd_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-deepz/'  
        args = pt.TransferArgs(net=config.CIFAR_CONV_SMALL, domain=Domain.DEEPZ, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=2/255,
                               split=Split.RELU_ESIP_SCORE, count=200, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
    ...
    def test_deepz_diffai_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-deepz/'  
        args = pt.TransferArgs(net=config.CIFAR_CONV_DIFFAI, domain=Domain.DEEPZ, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=2/255,
                               split=Split.RELU_ESIP_SCORE, count=200, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
    ...
    def test_deepz_colt_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-deepz/'  
        args = pt.TransferArgs(net=config.CIFAR_CONV_COLT, domain=Domain.DEEPZ, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=2/255,
                               split=Split.RELU_ESIP_SCORE, count=200, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
    ...
    def test_deepz_crown_trained(self):
        ...
        store_in_file = True
        output_dir='final_results/cifar10-deepz/'  
        args = pt.TransferArgs(net=config.CIFAR_CROWN_IBP, domain=Domain.DEEPZ, approx=ap.Quantize(ap.QuantizationType.INT16), dataset=Dataset.CIFAR10, eps=2/255,
                               split=Split.RELU_ESIP_SCORE, count=200, pt_method=ProofTransferMethod.REUSE, 
                               timeout=200, output_dir=output_dir, prop_index=None, ignore_properties=[], 
                               pruning_args=pruning_args, enable_sparsification=enable_sparsification, store_in_file=store_in_file)
        pt.proof_transfer(args)
